...
class GarminJsonActivityData(JsonFileProcessor):
    ...
    def _process_common(self, json_data):
        ...
        return {
            ...
            'avg_power'                 : self._get_field(json_data, 'averagePower', float),
            'max_power'                 : self._get_field(json_data, 'maxPower', float),
            'normalized_power'          : self._get_field(json_data, 'normPower', float),
            'threshold_power'           : self._get_field(json_data, 'functionalThresholdPower', float),
